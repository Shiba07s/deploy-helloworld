    ...
    stages{
         stage("clone code"){
            steps {
                ...
                git url:"https://github.com/Shiba07s/deploy-helloworld.git", branch:"main"
            }
        ...
        stage('Deploy') {
            steps {
                 deploy adapters: [tomcat9(credentialsId: 'tomcat', path: '', url: 'http://16.170.143.161:8090/')], contextPath: 'world_app', jar: '**/*.jar'
            }
        }
        // stage('Deploy') {
        //     steps {
